...
<div class="main">
    <div>
        <h1 class="inner-heading">Our Facilities</h1>
        <p class="content">
        ...
        <div style={{display: 'flex'}}>
            <img class="infrastructure" style={{height: '400px', width: '320px' ,margin: '0px', paddingLeft: '0px'}} src={comp1} alt="" />
            <img class="infrastructure" style={{height: '400px', width: '320px', margin:'0px', paddingLeft: '0px'}} src={comp2} alt="" />
        </div>
    </div>
</div>
        <Footer />
