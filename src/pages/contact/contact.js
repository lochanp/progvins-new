...
const contact = () => {
  return (
    <div>
      <Navbar />
      <div class="back-img">
        <h2 class="sub-heading sub">CONTACT US</h2>
      </div>
      ...
      <div className='main'>
        <form>
          ...
          <div class="mb-3">
            <label for="exampleInputPassword1" class="form-label">Requirement Details</label>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-text">
              <i class="fas fa-map-marker-alt"></i> RRR House, Plot 80, Sector- 23,CIDCO Industrial Area,<br /> Near Bank Of India, Navi Mumbai, Thane-400705, Maharashtra, India
              <br /><i class="fas fa-directions"></i>  <a href="https://www.google.com/maps/place/80,+Sector+23,+Turbhe,+Navi+Mumbai,+Maharashtra+400703/@19.0707833,73.0140574,17z/data=!3m1!4b1!4m5!3m4!1s0x3be7c141e7c7a0eb:0x2da7ccd23d977295!8m2!3d19.0707782!4d73.0162461" rel='noreferrer' target="_blank" class="card-link" style={{textDecoration:'underline'}}><small>Get Directions</small></a>
              <br /><br /><i class="fas fa-envelope"></i> Mail Us : <a href="mailto:progvins@progvins.com" target="_blank" rel='noreferrer'>progvins@progvins.com</a> / <a href="mailto:s.rane@rrrlabs.com" rel='noreferrer' target="_blank">s.rane@rrrlabs.com</a>
              <br /><br /><i class="fas fa-phone-alt"></i>  Call Us: <a href="tel: 7208010008" style={{textDecoration:'underline'}}> 7208010008</a> <a href="tel: 7506588896" style={{textDecoration:'underline'}}> ,7506588896</a>
            </p>
          </div>
      </div>
      </div>
