...
const GoldService = () => {
  return (
    <div className='services-page'> 
        ...
        <div className="main">
            <div>
                <h1 className="inner-heading">What is Gold Plating ?</h1>
                <p className="content">
                ...
                <div>
                    <img className="middle-img" style={{height: "400px", width: "380px", marginLeft: "140px"}} alt='gold' src={goldItem} />
                </div>
            </div>   
        </div>
        <div className="main">
            <div>
                <h1 className="inner-heading">Gold Brush/Selective Plating</h1>
                <p className="content">
        ...
        <div className="main main-one-col">
            <h1 className="inner-heading">Electroless Gold Plating
            </h1>
            <p className="content">
        ...
        <div className="main">
            <div>
                <h1 className="inner-heading">Advantages/Benefits of Gold Plating</h1>
                <p className="content">
                ...
                <div>
                    <img className="middle-img" style={{marginTop: '4rem'}} alt='' src={semiconductor} />
                </div>
            </div>
        </div>
        <div className="main  main-one-col">
            <div>
                <h2 className="inner-heading">Methods of Gold plating</h2>
                <p className="content" style={{marginBottom: "1rem"}}>
        ...
        Also, it is highly conductive for electricity, making it the perfect solution for many electronic applications.<br /><br />
                    ...
                    <small><i className="fas fa-dot-circle"></i></small> Gold Brush/Selective Plating<br />
                    <small><i className="fas fa-dot-circle"></i></small> Barrel/Vat Plating<br />
                    <small><i className="fas fa-dot-circle"></i></small> Rack Plating<br />
                </p>
            </div>
        </div>
        <div className="main-content">
