  ...
  return (
    <div className='plating-methods'>
        ...
        <div className="back-img-plating">
            <h2 className="sub-heading sub">PLATING METHODS</h2>
        </div>
        ...
        <div className="main">
            <div>
                ...
                <div>
                    <img className="plating-img" src={plating1} alt="" />
                </div>
            </div>
        </div>
        <h1 className="inner-heading">These are the different methods of plating services we offer:</h1>
        <div className="row">
            <div className="col-sm-6">
            <div className="card">
                <div className="card-body">
                <h5 className="card-title">Electroless Plating</h5>
                <p className="card-text">Electroless plating, also known as chemical or auto-catalytic plating, is a non-galvanic plating method that involves several simultaneous reactions in an aqueous solution, which occur without the use of external electrical power.
                ...
                <a href="electroless-method"><button className="btn btn-dark">Read More</button></a>
                </div>
            </div>
            </div>
            <div className="col-sm-6">
