...
const ElectrolessPlating = () => {
  return (
    <div className='electroless-page'>
        <Navbar />
        <div className="back-img-electro">
        ...
        <div className="main">
    <div>
        <h1 className="inner-heading">Electroless Plating</h1>
        <p className="content">
        ...
        <div style={{display: 'flex'}}>
            <img style={{height: '460px', width: '300px'}} className="infrastructure" src={ElectrolessImg} alt="" />
            <img style={{height: "460px" ,width: '300px'}} className="infrastructure" src={ElectrolessImg1} alt="" />
        </div>
    </div>
</div>
<div className="main  main-one-col">
    <div>
        <h1 className="inner-heading ">Electroless Plating Process</h1>
        <p className="content">
...
<div className="main  main-one-col">
    <div>
        <h1 className="inner-heading ">Advantages/Benefits Electroless Plating</h1>
        <p className="content">
