        ...
        <div className=''>
            ...
            <div className="row">
                <div className="col-sm-6">
                    <div className="card">
                        <div className="card-body">
                            <h5 className="card-title">Adhesion Testing:</h5>
                            <p className="card-text">We at Progvins have over the years refined our processes to not just meet but exceed industry standards. Adhesion is among the primary requirements in plating. We carry out adhesion tests online on our job floor to guarantee desired adhesion. We regularly partake and generate reports of our non destructive as well as destructive adhesion tests.
                            </p>
                        </div>
                    </div>
                </div>
                <div className="col-sm-6">
                    <div className="card">
                        <div className="card-body">
                            <h5 className="card-title">CASS / Neutral Salt Spray Testing:</h5>
                            <p className="card-text">Progvins has in house CASS and neutral salt spray testing facilities.  We change or modify our chemistry and process parameter to match and surpass the desired level of resistance. We periodically carry out CASS or neutral salt spray tests to validate our assurances and component tolerances.
                            </p>
                        </div>
                    </div>
            </div>
