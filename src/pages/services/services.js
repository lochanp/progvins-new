  ...
  return (
    <div className='services-page'>
        ...
        <div className="back-img">
            <h2 className="sub-heading sub">Our Services</h2>
        </div>
...
<div className="inner-main">
    <h1 className="inner-heading">Services We Provide</h1>
...
<h1 className="inner-heading">Gold Plating</h1>
<div className="row">
    ...
    <a href="gold-service"><button className="btn btn-dark read-btn">Read More</button></a>
</div>
</div>
<div className="col-sm-4">
    <img className="about-img" src={gold} alt="" />
</div>
</div>

<h1 className="inner-heading">Silver Plating</h1>
<div className="row">
    <div className="col-sm-7">
    <div className="inner-content para">
    ...
    <a href="silver-service"><button className="btn btn-dark read-btn">Read More</button></a>
</div>
</div>
<div className="col-sm-4">
    <img className="" width="129%" height="210vh" src={silver} alt="" />
</div>
</div>
 <h1 className="inner-heading">Platinum Plating</h1>
<div className="row">
    <div className="col-sm-7">
    <div className="inner-content para">
    ...
    <a href="platium-service"><button className="btn btn-dark read-btn">Read More</button></a>
</div>
</div>
<div className="col-sm-4">
    <img className="service-img" src={platinum} alt="" />
</div>
</div>
<h1 className="inner-heading">Palladium Plating</h1>
<div className="row">
    <div className="col-sm-7">
    <div className="inner-content para">
    ...
    <a href="palladium-service"><button className="btn btn-dark read-btn">Read More</button></a>
</div>
</div>
<div className="col-sm-4">
    <img className="service-img" src={palladium} alt="" />
</div>
 <h1 className="inner-heading">Rhodium Plating</h1>
<div className="row">
    <div className="col-sm-7">
    <div className="inner-content para">
    ...
    <a href="rhodium-service"><button className="btn btn-dark read-btn">Read More</button></a>
</div>
</div>
<div className="col-sm-4">
    <img className="service-img" src={rhodium} alt="" />
</div>
</div>
<h1 className="inner-heading">Precious Metal Deposition</h1>
<div className="row">
    <div className="col-sm-7">
    <div className="inner-content para">
    ...
    <a href="pmd-service"><button className="btn btn-dark read-btn">Read More</button></a>
</div>
</div>
<div className="col-sm-4">
    <img className="service-img" src="/imgs/precious-metal-deposition.jpg" alt="" />
</div>
</div>
</div>
    <div className="main-content">
