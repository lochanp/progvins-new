...
const ElectroPlating = () => {
  return (
    <div className='electroplating-page'>
        <Navbar />
        <div className="back-img-plating">
    <h2 className="sub-heading">Plating Methods <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-arrow-right" viewBox="0 0 16 16">
...
<div className="main">
    <div>
        <h1 className="inner-heading">Electroplating</h1>
        <p className="content">
        ...
        <div>
            <img className="infrastructure" src={Electro1} alt="" />
        </div>
    </div>
</div>
<div className="main  main-one-col">
    <div>
        <h1 className="inner-heading ">Electroplating Process</h1>
        <p className="content">
            ...
            <small><i className="fas fa-dot-circle"></i></small> Strike<br />
            <small><i className="fas fa-dot-circle"></i></small> Electrochemical deposition<br />
            <small><i className="fas fa-dot-circle"></i></small> Pulse electroplating<br />
            <small><i className="fas fa-dot-circle"></i></small> Brush/Selective electroplating<br />
            <small><i className="fas fa-dot-circle"></i></small> Barrel/Vat plating<br />
        </p>
    </div>
</div>
<div className="main main-one-col">
    <h1 className="inner-heading">Brush/Selective Electroplating Gold/Sliver</h1>
    <iframe className='vid' width="600" height="325" src="https://www.youtube-nocookie.com/embed/4wfAiGkdGnU?&" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>

<div className="main-content-plating">
    <p className="main-initial">    
        ...
        <a style={{margin: '1rem'}} href="tel: 08048361318"><button className="btn btn-light">Call Us</button></a>
